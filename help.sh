...
echo "  With Grafana enabled: istioctl install -f istio-grafana.yaml"
echo "  With all addons and optimized configuration: istioctl install -f istio-full.yaml"
echo "  Add observability addons to existing installation: ./install-addons.sh"
echo ""
